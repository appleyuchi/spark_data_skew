...
|导致shuffle的算子<br>执行时的并行度不够|提升并行度|[提升并行度配置或代码配置](https://github.com/appleyuchi/spark_data_skew/blob/master/Java/%E6%8F%90%E9%AB%98partition%E5%B9%B6%E8%A1%8C%E5%BA%A6.txt)|||[1]解决方案三
|数据集可大可小|自定义Partitioner<br>根据数据量不同返回一个灵活的自适应的并行度|[自定义partition数量](https://github.com/appleyuchi/spark_data_skew/blob/master/Java/%E8%87%AA%E5%AE%9A%E4%B9%89partition.txt)[3]|||参考自[3]
